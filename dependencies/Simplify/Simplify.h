...
inline vec3f interpolate(const vec3f& p, const vec3f& a, const vec3f& b,
...
namespace Simplify
{
    ...
    static std::vector<Ref> refs;
    static std::string mtllib;
	...
	static void simplify_mesh(int target_count, double agressiveness=7, bool verbose=false)
	{
		// init
	...
	static void simplify_mesh_lossless(bool verbose = false)
	{
		// init
	...
	static bool flipped(vec3f p, int i0, int i1, Vertex& v0, Vertex& v1,
	...
	static void update_uvs(int i0, const Vertex& v, const vec3f& p,
                               std::vector<int>& deleted)
	{
		loopk(0,v.tcount)
		{
	...
	static void update_triangles(int i0, Vertex& v,
                                     std::vector<int>& deleted,
	...
	static double vertex_error(SymetricMatrix q, double x, double y,
                                   double z)
	{
	...
	static double calculate_error(int id_v1, int id_v2, vec3f& p_result)
	{
	...
	//Option : Load OBJ
	static void load_obj(const char* filename, bool process_uv=false){
		vertices.clear();
		triangles.clear();
	...
	static void write_obj(const char* filename)
	{
