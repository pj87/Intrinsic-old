...
typedef std::vector<ComputeCallRef> ComputeCallRefArray;
                                          ...
                                          _INTR_MAX_COMPUTE_CALL_COUNT>
{
  /*_INTR_INLINE*/ static void init();
      /*
      {
        ...
        Dod::Resources::ResourceManagerBase<
            ComputeCallData,
      _INTR_MAX_COMPUTE_CALL_COUNT>::_initResourceManager();
      }
      */
      ...
      /*
      {
        ComputeCallRef ref = Dod::Resources::ResourceManagerBase<
            ComputeCallData,
      _INTR_MAX_COMPUTE_CALL_COUNT>::_createResource(p_Name); return ref;
      }
      */
      ...
      */
      ...
      /*
      {
        Dod::Resources::ResourceManagerBase<
            ComputeCallData,
      _INTR_MAX_COMPUTE_CALL_COUNT>::_destroyResource(p_Ref);
      }
      */

      /*_INTR_INLINE*/
      static void compileDescriptor(ComputeCallRef p_Ref, bool p_GenerateDesc,
      ...
      /*
      {
        Dod::Resources::ResourceManagerBase<
            ComputeCallData,
            _INTR_MAX_COMPUTE_CALL_COUNT>::_compileDescriptor(p_Ref,
      p_GenerateDesc, p_Properties, p_Document);
      }
      */

      /*_INTR_INLINE*/
      static void initFromDescriptor(ComputeCallRef p_Ref,
                                     rapidjson::Value& p_Properties);
      /*
      {
        Dod::Resources::ResourceManagerBase<
  ...
  /*_INTR_INLINE*/ static PipelineRef& _descPipeline(PipelineLayoutRef p_Ref);
      ...
      */
      ...
      /*_INTR_INLINE*/ static std::vector<uint32_t> &
      ...
      */
      /*_INTR_INLINE*/
      static VkDescriptorSet& _vkDescriptorSet(PipelineLayoutRef p_Ref);
  /*
  {
