...
typedef std::vector<BufferRef> BufferRefArray;
...
struct BufferData : Dod::Resources::ResourceDataBase
{
  ...
  std::vector<BufferType::Enum> descBufferType;
  std::vector<MemoryPoolType::Enum> descMemoryPoolType;
  std::vector<uint32_t> descSizeInBytes;
  std::vector<void*> descInitialData;

  std::vector<VkDescriptorBufferInfo> vkDescriptorBufferInfo;
  std::vector<VkBuffer> vkBuffer;
  std::vector<GpuMemoryAllocationInfo> memoryAllocationInfo;
};
    ...
    : Dod::Resources::ResourceManagerBase<BufferData, _INTR_MAX_BUFFER_COUNT>
{
  ...
  */
  ...
  /*
  {
    Dod::Resources::ResourceManagerBase<BufferData,
  _INTR_MAX_BUFFER_COUNT>:: _loadFromSingleFile(p_FileName,
  initFromDescriptor, resetToDefault);
  }
  */
  // <-
  ...
  */
  ...
  /*_INTR_INLINE*/
  static void destroyBuffersAndResources(const BufferRefArray& p_Buffers);
  /*
  {
  ...
  */
  ...
  /*_INTR_INLINE*/
  static MemoryPoolType::Enum& _descMemoryPoolType(BufferRef p_Ref);
  /*
  {
  ...
  */
  /*_INTR_INLINE*/
  static GpuMemoryAllocationInfo& _memoryAllocationInfo(BufferRef p_Ref);
  /*
  {
