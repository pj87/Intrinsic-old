...
typedef std::vector<ImageRef> ImageRefArray;
...
struct ImageData : Dod::Resources::ResourceDataBase
{
  ...
  std::vector<Format::Enum> descImageFormat;
    ...
    : Dod::Resources::ResourceManagerBase<ImageData, _INTR_MAX_IMAGE_COUNT>
{
  ...
  */
  ...
  compileDescriptor(ImageRef p_Ref, bool p_GenerateDesc,
  ...
  */
  /*_INTR_INLINE*/ static void
  initFromDescriptor(ImageRef p_Ref, rapidjson::Value& p_Properties);
  /*
  {
    Dod::Resources::ResourceManagerBase<
  ...
  */
  ...
  /*_INTR_INLINE*/ static void removeImageFlags(ImageRef p_Ref,
                                                uint8_t p_Flags);
  /*
  {
    _data.descImageFlags[p_Ref._id] &= ~p_Flags;
  ...
  */
  ...
  // Description
  /*_INTR_INLINE*/ static MemoryPoolType::Enum&
  _descMemoryPoolType(ImageRef p_Ref);
  /*
  {
  ...
  */
  /*_INTR_INLINE*/ static std::string& _descFileName(ImageRef p_Ref);
  /*
  {
  ...
  */
  /*_INTR_INLINE*/ static ImageViewArray&
  _vkSubResourceImageViews(ImageRef p_Ref);
  /*
  {
