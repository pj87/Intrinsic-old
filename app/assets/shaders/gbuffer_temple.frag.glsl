...
void main()
{
  ...
  GBuffer gbuffer;
  {
	...
	gbuffer.albedo = vec4(tex3D(inPosition, inNormalTPM, albedoTex), 1.0) * uboPerInstance.colorTint;
	//gbuffer.albedo = vec4(tex3D(inPosition, inNormalTPM, normalTex), 1.0) * uboPerInstance.colorTint;
