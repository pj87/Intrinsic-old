...
{	
	...
	for (i = 0; i < 5; i++)
	{
		...
		{	
			...
			storePosition(idx * 15 + (3 * i + 0), (v0.position.xyz + 20.0) / 10.0);
			...
			storePosition(idx * 15 + (3 * i + 1), (v1.position.xyz + 20.0) / 10.0);
			...
			storePosition(idx * 15 + (3 * i + 2), (v2.position.xyz + 20.0) / 10.0);
