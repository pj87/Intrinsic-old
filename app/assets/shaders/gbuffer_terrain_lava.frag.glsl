...
void main()
{
  ...
  const vec4 albedo0 = vec4(tex3D(inPosition * 1.0, inNormalTPM, albedoTex0), 1.0);
  ...
  vec3 albedo = blend(albedo0.rgb * 1.0, albedo1.rgb * 1.0, albedo2.rgb * 1.0, blendMask * 0.5, noise);
  vec3 normal = blend(normal0.rgb * 1.0, normal1.rgb * 1.0, normal2.rgb * 0.0, blendMask * 0.5, noise);
  vec2 pbr = blend(pbr0.rgb * 1.0, pbr1.rgb * 1.0, pbr2.rgb * 0.0, blendMask * 1.5, noise).rg;
